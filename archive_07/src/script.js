...
const colorTexture = textureLoader.load('/nongsidebar.png')
const checkTexture = textureLoader.load('/textures/minecraft.png')

// checkTexture.repeat.x = 1
// checkTexture.repeat.y = 1
...
checkTexture.rotation = Math.PI

checkTexture.generateMipmaps = false
